...
protocol FL2DTransformListener : NSObjectProtocol {
    ...
    func onBeginSingleTouchRotate() -> Void
    func onEndSingleTouchRotate() -> Void

    func onStart(_ li:FLSimple2DTransformGesture, _ pointerID:Int) -> Void
    func onFinish(_ li:FLSimple2DTransformGesture, _ pointerID:Int) -> Void
}
...
extension FL2DTransformListener {
    ...
    func onBeginSingleTouchRotate() { }
    func onEndSingleTouchRotate() { }

    func onStart(_ li:FLSimple2DTransformGesture, _ pointerID:Int) { }
    func onFinish(_ li:FLSimple2DTransformGesture, _ pointerID:Int) -> Void { }
}
