...
//        FLPrimitives.peekStringSize("Create bizarre and wonderful \nexpressions with Surreal Art")
    ...
    // zht = "zh-Hant" , "zh-TW" , "zh-HK"
    // zhs = "zh-Hans" , "zh-CN"
    // "de" ,"es" ,"fr" ,"it" ,"id" ,"ja" ,"ko" ,"ms" ,"pl" ,"pt" ,"ru" ,"nl" ,"tr" ,"th" ,"fa"
    @objc
    class func isLanguageOf(_ s:String) -> Bool {
        let it = Locale.preferredLanguages[0];
        return it.hasPrefix(s)
    }
}
