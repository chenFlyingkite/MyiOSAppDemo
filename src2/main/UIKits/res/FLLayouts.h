...
// height = match parent
//+ (NSArray<NSLayoutConstraint*>*) view:(__kindof UIView*)v1 layoutVertical:(NSArray<__kindof UIView*>*)v2;
// width = match parent
//+ (NSArray<NSLayoutConstraint*>*) view:(__kindof UIView*)v1 layoutHorizontal:(NSArray<__kindof UIView*>*)v2;
